...
import { UploadUserCover } from '../Services/UserDetailsServices.js';
import { queryClient } from '../App.jsx';
import toast from 'react-hot-toast';

export default function ChangeCoverPictureModal({ isOpen, onClose, currentImageUrl }) {
  ...
  const { mutate: uploadImage, isPending } = useMutation({
    mutationFn: (formData) => UploadUserCover(formData),
    onSuccess: () => {
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-lg sm:max-w-xl p-4"
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden" style={{ backgroundColor: themeColors.surface }}>
          <div className="p-4 border-b border-gray-100">
            <h2 className="text-lg font-semibold" style={{ color: themeColors.text }}>Update Cover Picture</h2>
          </div>

          <div className="p-4">
            <div className="w-full h-40 sm:h-56 rounded-xl overflow-hidden border border-gray-100 bg-gray-50 relative">
              {previewUrl ? (
